...
Giá trị cốt lõi của nghiên cứu này không chỉ nằm ở những phát hiện kỹ thuật mà còn ở tác động trực tiếp đến y tế công cộng và cộng đồng địa phương. Hệ thống sàng lọc dựa trên học máy có khả năng giúp các cơ sở y tế cơ sở trong những vùng có tỷ lệ bệnh nhân đái tháo đường cao nhất thực hiện tầm soát sớm một cách hiệu quả hơn. Bằng cách xác định những nhóm đối tượng có nguy cơ cao dựa trên các chỉ số sinh hiệu đơn giản (Glucose, BMI, tuổi...), các bác sĩ địa phương có thể tập trung nguồn lực y tế hạn chế vào những trường hợp cần thiết nhất, từ đó giảm thiểu gánh nặng biến chứng và chi phí điều trị dài hạn.

Đặc biệt, ứng dụng của công nghệ thông tin trong lĩnh vực y tế không chỉ nâng cao hiệu quả chẩn đoán mà còn góp phần dân chủ hóa tiếp cận y tế ở những vùng sâu, vùng xa hoặc những cộng đồng có khả năng tiếp cận chuyên gia y tế hạn chế. Khi các mô hình học máy được triển khai trên các thiết bị di động hoặc trong các hệ thống thông tin y tế tích hợp, chúng trở thành những công cụ hỗ trợ quyết định có giá trị to lớn cho những bác sĩ địa phương mà không cần phụ thuộc vào những chuyên gia tập trung ở thành phố lớn. Vì vậy, việc thiết lập một khung đánh giá chặt chẽ và có khả năng tái lập cho các mô hình này chính là tiền đề cần thiết để đảm bảo rằng những công cụ được triển khai trên thực địa là những công cụ đáng tin cậy, an toàn và mang lại lợi ích thực sự cho người bệnh và cộng đồng.
...
\noindent Hệ thống các bảng số liệu thực nghiệm, chỉ số hiệu chuẩn và tệp kiểm định chi tiết được lưu trữ và trình bày đầy đủ tại các bảng biểu thuộc Phụ lục này.
...
Phiếu khảo sát dưới đây được thiết kế nhằm thu thập dữ liệu định tính từ các chuyên gia CNTT, nhân viên y tế và người dùng cuối, nhằm xác định mức độ nhận thức và tin tưởng vào ứng dụng các thuật toán học máy trong dự báo nguy cơ đái tháo đường. Dữ liệu thu được từ khảo sát này (dự kiến từ 30--50 phiếu) sẽ được xử lý bằng phương pháp tính hệ số tương quan thứ bậc Spearman (Phụ lục~\ref{app:spearman}), nhằm đánh giá mối liên hệ giữa các yếu tố ảnh hưởng đến việc chấp nhận và triển khai công nghệ.
...
Theo yêu cầu của tiểu luận môn học PPNCKH, phần này trình bày đầy đủ thông tin về việc sử dụng các công cụ trí tuệ nhân tạo trong quá trình thực hiện đề tài, nhằm đảm bảo tính minh bạch và tuân thủ các quy chuẩn học thuật.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{p{1.8cm}p{1.8cm}p{2.2cm}p{3.5cm}p{2.3cm}}
    ...
    \midrule
    \textbf{Soạn thảo báo cáo} & NotebookLM & Chuẩn hóa văn phong \& xây dựng cấu trúc & Hỗ trợ xây dựng đề cương chi tiết cho 5 chương, tóm tắt các ý chính, chuẩn hóa các dạng câu trong tiêu đề và mô tả & Hỗ trợ (20--25\%) \\
    \midrule
...
\textit{Công cụ AI (NotebookLM) đã hỗ trợ gợi ý một cấu trúc quản lý dự án học máy tiêu chuẩn (bao gồm các thư mục kỹ thuật như \texttt{resources}, \texttt{outputs}...). Tuy nhiên, để phù hợp với quy cách tiểu luận và thuận tiện cho việc chấm bài của giảng viên, \textbf{người viết đã chuyển đổi và trình bày toàn bộ các kết quả, thông số này trực tiếp vào phần Phụ lục của báo cáo thay vì nộp các tệp tin cấu hình riêng lẻ}. Điều này giúp đảm bảo tính minh bạch, kiểm soát nội dung và phù hợp với yêu cầu thực tế của môn học.}
...
\subsubsection*{Những phần không sử dụng AI}

Các phần \textbf{cốt lõi} của đề tài thực hiện hoàn toàn độc lập:
\begin{itemize}
